...
function Cards(props : Props) {
  ...
  return (
    <div className="w-[239px] h-[511px] dark:bg-[#3B3E47] shadow-lg shadow-slate-300 dark:shadow-black/75 p-2 hover:scale-110 "> 
        <img src={image} className="object-cover h-[385px] w-[387px]"  alt="" /> 
        <h2 className="font-normal font-serif px-2  text-lg py-2">{name}</h2>
        <div className="flex justify-between text-sm py-2 dark:bg-[#292B32] font-bold px-2 whitespace-nowrap tracking-wider">
